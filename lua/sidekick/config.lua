...
local defaults = {
  ...
  cli = {
    ...
    ---@field backend? "tmux"|"zellij"|"agent-deck" Multiplexer backend to persist CLI sessions
    mux = {
      ...
      -- NOTE: zellij and agent-deck only support `terminal`
...
function M.setup(opts)
  ...
  vim.schedule(function()
    ...
    M.validate("cli.mux.backend", { "tmux", "zellij", "agent-deck" })
